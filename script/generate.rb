...
ENV['ST_OPENAI_USE']        = should_use
ENV['ST_OPENAI_DATA']       = content
ENV['ST_APP_NAME']          = raw_app_name
ENV['ST_USE_API']           = use_api.to_s

template = "https://raw.githubusercontent.com/aFightClub/SnailTrain/main/script/template.rb"
